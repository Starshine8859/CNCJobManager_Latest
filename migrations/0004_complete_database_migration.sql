-- Complete Database Migration: From Old Structure to New Structure
...
-- 8. Migrate data from old color_groups to locations
...
-- 9. Migrate data from old colors to supplies
